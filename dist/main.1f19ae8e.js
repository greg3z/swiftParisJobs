...
var strings = {
  ...
  sendSuccess: 'Merci ! Je vous recontacte prochainement ! 👋' // allow global jquery access for debbuging more easily

};

if ("development" === 'development') {
  window.jq = _jquery.default;
}

(0, _jquery.default)(function () {
  var nav = document.getElementById('nav'); // on scroll toggle nav shadow

  window.addEventListener('scroll', function () {
    var shouldShowDropShadow = window.scrollY > 10;
    var boxShadowEnabled = !!nav.style.boxShadow;
  ...
  (0, _jquery.default)('[data-scrollto]').on('click', function (e) {
    e.preventDefault();
    var anchor = (0, _jquery.default)(e.target).data('scrollto');
    var navHeight = nav.getBoundingClientRect().height;
    var top = Math.max(0, (0, _jquery.default)(anchor).offset().top - navHeight);
    (0, _jquery.default)('html, body').stop().animate({
      scrollTop: "".concat(top, "px")
    }, 300);
  }); // perform an ajax call to google sheet
  // https://medium.com/@dmccoy/how-to-submit-an-html-form-to-google-sheets-without-google-forms-b833952cc175

  var form = (0, _jquery.default)('form#subscribe');
  var sending = (0, _jquery.default)('#sending');
  var sent = (0, _jquery.default)('#sent');
  var email = (0, _jquery.default)('form#subscribe #email');
